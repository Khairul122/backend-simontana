...
/*
|--------------------------------------------------------------------------
| Backward Compatibility Aliases (non-versioned → v1)
|--------------------------------------------------------------------------
| Klien lama yang masih hit /api/auth/login, /api/laporans, dll
| tetap terlayani tanpa perubahan. Hapus section ini ketika semua
| klien sudah migrasi ke /api/v1/*.
*/
